...
<div id="border">
    ...
    <div class="sidemenu">
    	...
    	<button type="button" class="button button-update" style="background-color: blue;"><span style="color: white;">회원탈퇴</span></button>
...
<input type="submit" value="탈퇴하기" style="font-size:20px;">
</fieldset>
</form>
